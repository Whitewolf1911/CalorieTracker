...
class CalculateMealNutrients(
    ...
    operator fun invoke(trackedFoods: List<TrackedFood>): Result {
        ...
        val carbsGoal = (caloriesGoal * userInfo.carbRatio / CALORIE_PER_CARB_GR).roundToInt()
        val proteinGoal = (caloriesGoal * userInfo.proteinRatio / CALORIE_PER_FAT_GR).roundToInt()
        val fatGoal = (caloriesGoal * userInfo.proteinRatio / CALORIE_PER_PROTEIN_GR).roundToInt()
    ...
    companion object{
        private const val CALORIE_PER_CARB_GR = 4f
        private const val CALORIE_PER_FAT_GR = 4f
        private const val CALORIE_PER_PROTEIN_GR = 9f
    }
}
